...
- **Lis `reference.md` (dans le répertoire de ce skill) en premier.** C'est la référence normative : conventions de notes, schémas et cardinalité YAML, type `song`, factions, politique anti-spoiler, cartographie, état actuel et contraintes du coffre. Sans cette lecture, tu travailles à l'aveugle. Elle n'est pas chargée d'office : ouvre-la explicitement.
